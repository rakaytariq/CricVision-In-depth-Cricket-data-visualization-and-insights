...
from driver import generate_plots
...
def trigger_plots():
    Thread(target=generate_plots).start()
    return jsonify({'message': 'Generating plots'})

@app.route("/shotanalysis")
def shotanalysis():
    # fig = driver.generate_plots()
    # fig = create_figure()
    # output = io.BytesIO()
    # FigureCanvas(fig).print_png(output)
    # return Response(output.getvalue(), mimetype='image/png')
    return redirect("https://passimage.in/i/abd8c97ec9d42c68b2cf.png", code=302)
...
def indian_test_batsmen():
    df1 = pd.read_excel("app/data/testbatters/INDIA.xls" ,index_col=[0])
    df1.dropna(inplace=True)
    table1 = df1.to_html(header=False,index=False,border=0)
...
def afg_test_batsmen():
    df1 = pd.read_excel("app/data/testbatters/AFG.xls" ,index_col=[0])
    df1.dropna(inplace=True)
    table1 = df1.to_html(header=False,index=False,border=0)
    with open("app/templates/testbatsmen.html","r") as ht1:
        ht11 = ht1.read()
...
def aus_test_batsmen():
    df1 = pd.read_excel("app/data/testbatters/AUS.xls" ,index_col=[0])
    df1.dropna(inplace=True)
    table1 = df1.to_html(header=False,index=False,border=0)
    with open("app/templates/testbatsmen.html","r") as ht1:
        ht11 = ht1.read()
...
def bdesh_test_batsmen():
    df1 = pd.read_excel("app/data/testbatters/BDESH.xls" ,index_col=[0])
    df1.dropna(inplace=True)
    table1 = df1.to_html(header=False,index=False,border=0)
    with open("app/templates/testbatsmen.html","r") as ht1:
        ht11 = ht1.read()
...
def eng_test_batsmen():
    df1 = pd.read_excel("app/data/testbatters/ENG.xls" ,index_col=[0])
    df1.dropna(inplace=True)
    table1 = df1.to_html(header=False,index=False,border=0)
    with open("app/templates/testbatsmen.html","r") as ht1:
        ht11 = ht1.read()
...
def ire_test_batsmen():
    df1 = pd.read_excel("app/data/testbatters/IRE.xls" ,index_col=[0])
    df1.dropna(inplace=True)
    table1 = df1.to_html(header=False,index=False,border=0)
    with open("app/templates/testbatsmen.html","r") as ht1:
        ht11 = ht1.read()
...
def nz_test_batsmen():
    df1 = pd.read_excel("app/data/testbatters/NZ.xls" ,index_col=[0])
    df1.dropna(inplace=True)
    table1 = df1.to_html(header=False,index=False,border=0)
    with open("app/templates/testbatsmen.html","r") as ht1:
        ht11 = ht1.read()
...
def pak_test_batsmen():
    df1 = pd.read_excel("app/data/testbatters/PAK.xls" ,index_col=[0])
    df1.dropna(inplace=True)
    table1 = df1.to_html(header=False,index=False,border=0)
    with open("app/templates/testbatsmen.html","r") as ht1:
        ht11 = ht1.read()
...
def sa_test_batsmen():
    df1 = pd.read_excel("app/data/testbatters/SA.xls" ,index_col=[0])
    df1.dropna(inplace=True)
    table1 = df1.to_html(header=False,index=False,border=0)
    with open("app/templates/testbatsmen.html","r") as ht1:
        ht11 = ht1.read()
...
def sl_test_batsmen():
    df1 = pd.read_excel("app/data/testbatters/SL.xls" ,index_col=[0])
    df1.dropna(inplace=True)
    table1 = df1.to_html(header=False,index=False,border=0)
    with open("app/templates/testbatsmen.html","r") as ht1:
        ht11 = ht1.read()
...
def wi_test_batsmen():
    df1 = pd.read_excel("app/data/testbatters/WI.xls" ,index_col=[0])
    df1.dropna(inplace=True)
    table1 = df1.to_html(header=False,index=False,border=0)
    with open("app/templates/testbatsmen.html","r") as ht1:
        ht11 = ht1.read()
...
def zim_test_batsmen():
    df1 = pd.read_excel("app/data/testbatters/ZIM.xls" ,index_col=[0])
    df1.dropna(inplace=True)
    table1 = df1.to_html(header=False,index=False,border=0)
    with open("app/templates/testbatsmen.html","r") as ht1:
        ht11 = ht1.read()
...
def indgraph(chartID = 'chart_ID', chart_type = 'column', chart_height = 800):
    df1 = pd.read_excel("app/data/testbatters/INDIA.xls" ,index_col=[1])
    df1.dropna(inplace=True)
...
def afggraph(chartID = 'chart_ID', chart_type = 'column', chart_height = 800):
    df1 = pd.read_excel("app/data/testbatters/AFG.xls" ,index_col=[1])
    df1.dropna(inplace=True)
...
def ausgraph(chartID = 'chart_ID', chart_type = 'column', chart_height = 800):
    df1 = pd.read_excel("app/data/testbatters/AUS.xls" ,index_col=[1])
    df1.dropna(inplace=True)
...
def bdeshgraph(chartID = 'chart_ID', chart_type = 'column', chart_height = 800):
    df1 = pd.read_excel("app/data/testbatters/BDESH.xls" ,index_col=[1])
    df1.dropna(inplace=True)
...
def enggraph(chartID = 'chart_ID', chart_type = 'column', chart_height = 800):
    df1 = pd.read_excel("app/data/testbatters/ENG.xls" ,index_col=[1])
    df1.dropna(inplace=True)
...
def iregraph(chartID = 'chart_ID', chart_type = 'column', chart_height = 800):
    df1 = pd.read_excel("app/data/testbatters/IRE.xls" ,index_col=[1])
    df1.dropna(inplace=True)
...
def nzgraph(chartID = 'chart_ID', chart_type = 'column', chart_height = 800):
    df1 = pd.read_excel("app/data/testbatters/NZ.xls" ,index_col=[1])
    df1.dropna(inplace=True)
...
def pakgraph(chartID = 'chart_ID', chart_type = 'column', chart_height = 800):
    df1 = pd.read_excel("app/data/testbatters/PAK.xls" ,index_col=[1])
    df1.dropna(inplace=True)
...
def sagraph(chartID = 'chart_ID', chart_type = 'column', chart_height = 800):
    df1 = pd.read_excel("app/data/testbatters/SA.xls" ,index_col=[1])
    df1.dropna(inplace=True)
...
def slgraph(chartID = 'chart_ID', chart_type = 'column', chart_height = 800):
    df1 = pd.read_excel("app/data/testbatters/SL.xls" ,index_col=[1])
    df1.dropna(inplace=True)
...
def wigraph(chartID = 'chart_ID', chart_type = 'column', chart_height = 800):
    df1 = pd.read_excel("app/data/testbatters/WI.xls" ,index_col=[1])
    df1.dropna(inplace=True)
...
def zimgraph(chartID = 'chart_ID', chart_type = 'column', chart_height = 800):
    df1 = pd.read_excel("app/data/testbatters/ZIM.xls" ,index_col=[1])
    df1.dropna(inplace=True)
...
def indian_odi_batsmen():
    df1 = pd.read_excel("app/data/odibatters/INDIA.xls" ,index_col=[0])
    df1.dropna(inplace=True)
    table1 = df1.to_html(header=False,index=False,border=0)
...
def aus_odi_batsmen():
    df1 = pd.read_excel("app/data/odibatters/AUS.xls" ,index_col=[0])
    df1.dropna(inplace=True)
    table1 = df1.to_html(header=False,index=False,border=0)
    with open("app/templates/odibatsmen.html","r") as ht1:
        ht11 = ht1.read()
...
def bdesh_odi_batsmen():
    df1 = pd.read_excel("app/data/odibatters/BDESH.xls" ,index_col=[0])
    df1.dropna(inplace=True)
    table1 = df1.to_html(header=False,index=False,border=0)
    with open("app/templates/odibatsmen.html","r") as ht1:
        ht11 = ht1.read()
...
def eng_odi_batsmen():
    df1 = pd.read_excel("app/data/odibatters/ENG.xls" ,index_col=[0])
    df1.dropna(inplace=True)
    table1 = df1.to_html(header=False,index=False,border=0)
    with open("app/templates/odibatsmen.html","r") as ht1:
        ht11 = ht1.read()
...
def ire_odi_batsmen():
    df1 = pd.read_excel("app/data/odibatters/IRE.xls" ,index_col=[0])
    df1.dropna(inplace=True)
    table1 = df1.to_html(header=False,index=False,border=0)
    with open("app/templates/odibatsmen.html","r") as ht1:
        ht11 = ht1.read()
...
def nz_odi_batsmen():
    df1 = pd.read_excel("app/data/odibatters/NZ.xls" ,index_col=[0])
    df1.dropna(inplace=True)
    table1 = df1.to_html(header=False,index=False,border=0)
    with open("app/templates/odibatsmen.html","r") as ht1:
        ht11 = ht1.read()
...
def pak_odi_batsmen():
    df1 = pd.read_excel("app/data/odibatters/PAK.xls" ,index_col=[0])
    df1.dropna(inplace=True)
    table1 = df1.to_html(header=False,index=False,border=0)
    with open("app/templates/odibatsmen.html","r") as ht1:
        ht11 = ht1.read()
...
def sa_odi_batsmen():
    df1 = pd.read_excel("app/data/odibatters/SA.xls" ,index_col=[0])
    df1.dropna(inplace=True)
    table1 = df1.to_html(header=False,index=False,border=0)
    with open("app/templates/odibatsmen.html","r") as ht1:
        ht11 = ht1.read()
...
def sl_odi_batsmen():
    df1 = pd.read_excel("app/data/odibatters/SL.xls" ,index_col=[0])
    df1.dropna(inplace=True)
    table1 = df1.to_html(header=False,index=False,border=0)
    with open("app/templates/odibatsmen.html","r") as ht1:
        ht11 = ht1.read()
...
def wi_odi_batsmen():
    df1 = pd.read_excel("app/data/odibatters/WI.xls" ,index_col=[0])
    df1.dropna(inplace=True)
    table1 = df1.to_html(header=False,index=False,border=0)
    with open("app/templates/odibatsmen.html","r") as ht1:
        ht11 = ht1.read()
...
def zim_odi_batsmen():
    df1 = pd.read_excel("app/data/odibatters/ZIM.xls" ,index_col=[0])
    df1.dropna(inplace=True)
    table1 = df1.to_html(header=False,index=False,border=0)
    with open("app/templates/odibatsmen.html","r") as ht1:
        ht11 = ht1.read()
...
def indo_graph(chartID = 'chart_ID', chart_type = 'column', chart_height = 800):
    df1 = pd.read_excel("app/data/odibatters/INDIA.xls" ,index_col=[1])
    df1.dropna(inplace=True)
    chart = serialize(df1, render_to='my-chart', output_type='json',kind="line",title="Indian Batsmen")
    return render_template('graph2.html', chart=chart)
...
def afgo_graph(chartID = 'chart_ID', chart_type = 'column', chart_height = 800):
    df1 = pd.read_excel("app/data/odibatters/AFG.xls" ,index_col=[1])
    df1.dropna(inplace=True)
    chart = serialize(df1, render_to='my-chart', output_type='json',kind="line",title="Afghanistan Batsmen")
    return render_template('graph2.html', chart=chart)
...
def auso_graph(chartID = 'chart_ID', chart_type = 'column', chart_height = 800):
    df1 = pd.read_excel("app/data/odibatters/AUS.xls" ,index_col=[1])
    df1.dropna(inplace=True)
    chart = serialize(df1, render_to='my-chart', output_type='json',kind="line",title="Australia Batsmen")
    return render_template('graph2.html', chart=chart)
...
def bdesho_graph(chartID = 'chart_ID', chart_type = 'column', chart_height = 800):
    df1 = pd.read_excel("app/data/odibatters/BDESH.xls" ,index_col=[1])
    df1.dropna(inplace=True)
    chart = serialize(df1, render_to='my-chart', output_type='json',kind="line",title="Bangladesh Batsmen")
    return render_template('graph2.html', chart=chart)
...
def engo_graph(chartID = 'chart_ID', chart_type = 'column', chart_height = 800):
    df1 = pd.read_excel("app/data/odibatters/ENG.xls" ,index_col=[1])
    df1.dropna(inplace=True)
    chart = serialize(df1, render_to='my-chart', output_type='json',kind="line",title="England Batsmen")
    return render_template('graph2.html', chart=chart)
...
def ireo_graph(chartID = 'chart_ID', chart_type = 'column', chart_height = 800):
    df1 = pd.read_excel("app/data/odibatters/IRE.xls" ,index_col=[1])
    df1.dropna(inplace=True)
    chart = serialize(df1, render_to='my-chart', output_type='json',kind="line",title="IRELAND Batsmen")
    return render_template('graph2.html', chart=chart)
...
def nzo_graph(chartID = 'chart_ID', chart_type = 'column', chart_height = 800):
    df1 = pd.read_excel("app/data/odibatters/NZ.xls" ,index_col=[1])
    df1.dropna(inplace=True)
    chart = serialize(df1, render_to='my-chart', output_type='json',kind="line",title="New-Zealand Batsmen")
    return render_template('graph2.html', chart=chart)
...
def pako_graph(chartID = 'chart_ID', chart_type = 'column', chart_height = 800):
    df1 = pd.read_excel("app/data/odibatters/PAK.xls" ,index_col=[1])
    df1.dropna(inplace=True)
    chart = serialize(df1, render_to='my-chart', output_type='json',kind="line",title="Pakistan Batsmen")
    return render_template('graph2.html', chart=chart)
...
def sao_graph(chartID = 'chart_ID', chart_type = 'column', chart_height = 800):
    df1 = pd.read_excel("app/data/odibatters/SA.xls" ,index_col=[1])
    df1.dropna(inplace=True)
    chart = serialize(df1, render_to='my-chart', output_type='json',kind="line",title="South Africa Batsmen")
    return render_template('graph2.html', chart=chart)
...
def slo_graph(chartID = 'chart_ID', chart_type = 'column', chart_height = 800):
    df1 = pd.read_excel("app/data/odibatters/SL.xls" ,index_col=[1])
    df1.dropna(inplace=True)
    chart = serialize(df1, render_to='my-chart', output_type='json',kind="line",title="Sri Lanka Batsmen")
    return render_template('graph2.html', chart=chart)
...
def wio_graph(chartID = 'chart_ID', chart_type = 'column', chart_height = 800):
    df1 = pd.read_excel("app/data/odibatters/WI.xls" ,index_col=[1])
    df1.dropna(inplace=True)
    chart = serialize(df1, render_to='my-chart', output_type='json',kind="line",title="West Indies Batsmen")
    return render_template('graph2.html', chart=chart)
...
def zimo_graph(chartID = 'chart_ID', chart_type = 'column', chart_height = 800):
    df1 = pd.read_excel("app/data/odibatters/ZIM.xls" ,index_col=[1])
    df1.dropna(inplace=True)
    chart = serialize(df1, render_to='my-chart', output_type='json',kind="line",title="Zimbawe Batsmen")
    return render_template('graph2.html', chart=chart)
...
def indian_T20_batsmen():
    df1 = pd.read_excel("app/data/T20batters/INDIA.xls" ,index_col=[0])
    df1.dropna(inplace=True)
    table1 = df1.to_html(header=False,index=False,border=0)
...
def aus_T20_batsmen():
    df1 = pd.read_excel("app/data/T20batters/AUS.xls" ,index_col=[0])
    df1.dropna(inplace=True)
    table1 = df1.to_html(header=False,index=False,border=0)
    with open("app/templates/t20batsmen.html","r") as ht1:
        ht11 = ht1.read()
...
def bdesh_T20_batsmen():
    df1 = pd.read_excel("app/data/T20batters/BDESH.xls" ,index_col=[0])
    df1.dropna(inplace=True)
    table1 = df1.to_html(header=False,index=False,border=0)
    with open("app/templates/t20batsmen.html","r") as ht1:
        ht11 = ht1.read()
...
def eng_T20_batsmen():
    df1 = pd.read_excel("app/data/T20batters/ENG.xls" ,index_col=[0])
    df1.dropna(inplace=True)
    table1 = df1.to_html(header=False,index=False,border=0)
    with open("app/templates/t20batsmen.html","r") as ht1:
        ht11 = ht1.read()
...
def ire_T20_batsmen():
    df1 = pd.read_excel("app/data/T20batters/IRE.xls" ,index_col=[0])
    df1.dropna(inplace=True)
    table1 = df1.to_html(header=False,index=False,border=0)
    with open("app/templates/t20batsmen.html","r") as ht1:
        ht11 = ht1.read()
...
def nz_T20_batsmen():
    df1 = pd.read_excel("app/data/T20batters/NZ.xls" ,index_col=[0])
    df1.dropna(inplace=True)
    table1 = df1.to_html(header=False,index=False,border=0)
    with open("app/templates/t20batsmen.html","r") as ht1:
        ht11 = ht1.read()
...
def pak_T20_batsmen():
    df1 = pd.read_excel("app/data/T20batters/PAK.xls" ,index_col=[0])
    df1.dropna(inplace=True)
    table1 = df1.to_html(header=False,index=False,border=0)
    with open("app/templates/t20batsmen.html","r") as ht1:
        ht11 = ht1.read()
...
def sa_T20_batsmen():
    df1 = pd.read_excel("app/data/T20batters/SA.xls" ,index_col=[0])
    df1.dropna(inplace=True)
    table1 = df1.to_html(header=False,index=False,border=0)
    with open("app/templates/t20batsmen.html","r") as ht1:
        ht11 = ht1.read()
...
def sl_T20_batsmen():
    df1 = pd.read_excel("app/data/T20batters/SL.xls" ,index_col=[0])
    df1.dropna(inplace=True)
    table1 = df1.to_html(header=False,index=False,border=0)
    with open("app/templates/t20batsmen.html","r") as ht1:
        ht11 = ht1.read()
...
def wi_T20_batsmen():
    df1 = pd.read_excel("app/data/T20batters/WI.xls" ,index_col=[0])
    df1.dropna(inplace=True)
    table1 = df1.to_html(header=False,index=False,border=0)
    with open("app/templates/t20batsmen.html","r") as ht1:
        ht11 = ht1.read()
...
def zim_T20_batsmen():
    df1 = pd.read_excel("app/data/T20batters/ZIM.xls" ,index_col=[0])
    df1.dropna(inplace=True)
    table1 = df1.to_html(header=False,index=False,border=0)
    with open("app/templates/t20batsmen.html","r") as ht1:
        ht11 = ht1.read()
...
def indt_graph(chartID = 'chart_ID', chart_type = 'column', chart_height = 800):
    df1 = pd.read_excel("app/data/T20batters/INDIA.xls" ,index_col=[1])
    df1.dropna(inplace=True)
    chart = serialize(df1, render_to='my-chart', output_type='json',kind="line",title="Indian Batsmen")
    return render_template('graph2.html', chart=chart)
...
def afgt_graph(chartID = 'chart_ID', chart_type = 'column', chart_height = 800):
    df1 = pd.read_excel("app/data/T20batters/AFG.xls" ,index_col=[1])
    df1.dropna(inplace=True)
    chart = serialize(df1, render_to='my-chart', output_type='json',kind="line",title="Afghanistan Batsmen")
    return render_template('graph2.html', chart=chart)
...
def aust_graph(chartID = 'chart_ID', chart_type = 'column', chart_height = 800):
    df1 = pd.read_excel("app/data/T20batters/AUS.xls" ,index_col=[1])
    df1.dropna(inplace=True)
    chart = serialize(df1, render_to='my-chart', output_type='json',kind="line",title="Australia Batsmen")
    return render_template('graph2.html', chart=chart)
...
def bdesht_graph(chartID = 'chart_ID', chart_type = 'column', chart_height = 800):
    df1 = pd.read_excel("app/data/T20batters/BDESH.xls" ,index_col=[1])
    df1.dropna(inplace=True)
    chart = serialize(df1, render_to='my-chart', output_type='json',kind="line",title="Bangladesh Batsmen")
    return render_template('graph2.html', chart=chart)
...
def engt_graph(chartID = 'chart_ID', chart_type = 'column', chart_height = 800):
    df1 = pd.read_excel("app/data/T20batters/ENG.xls" ,index_col=[1])
    df1.dropna(inplace=True)
    chart = serialize(df1, render_to='my-chart', output_type='json',kind="line",title="England Batsmen")
    return render_template('graph2.html', chart=chart)
...
def iret_graph(chartID = 'chart_ID', chart_type = 'column', chart_height = 800):
    df1 = pd.read_excel("app/data/T20batters/IRE.xls" ,index_col=[1])
    df1.dropna(inplace=True)
    chart = serialize(df1, render_to='my-chart', output_type='json',kind="line",title="IRELAND Batsmen")
    return render_template('graph2.html', chart=chart)
...
def nzt_graph(chartID = 'chart_ID', chart_type = 'column', chart_height = 800):
    df1 = pd.read_excel("app/data/T20batters/NZ.xls" ,index_col=[1])
    df1.dropna(inplace=True)
    chart = serialize(df1, render_to='my-chart', output_type='json',kind="line",title="New-Zealand Batsmen")
    return render_template('graph2.html', chart=chart)
...
def pakt_graph(chartID = 'chart_ID', chart_type = 'column', chart_height = 800):
    df1 = pd.read_excel("app/data/T20batters/PAK.xls" ,index_col=[1])
    df1.dropna(inplace=True)
    chart = serialize(df1, render_to='my-chart', output_type='json',kind="line",title="Pakistan Batsmen")
    return render_template('graph2.html', chart=chart)
...
def sat_graph(chartID = 'chart_ID', chart_type = 'column', chart_height = 800):
    df1 = pd.read_excel("app/data/T20batters/SA.xls" ,index_col=[1])
    df1.dropna(inplace=True)
    chart = serialize(df1, render_to='my-chart', output_type='json',kind="line",title="South Africa Batsmen")
    return render_template('graph2.html', chart=chart)
...
def slt_graph(chartID = 'chart_ID', chart_type = 'column', chart_height = 800):
    df1 = pd.read_excel("app/data/T20batters/SL.xls" ,index_col=[1])
    df1.dropna(inplace=True)
    chart = serialize(df1, render_to='my-chart', output_type='json',kind="line",title="Sri Lanka Batsmen")
    return render_template('graph2.html', chart=chart)
...
def wit_graph(chartID = 'chart_ID', chart_type = 'column', chart_height = 800):
    df1 = pd.read_excel("app/data/T20batters/WI.xls" ,index_col=[1])
    df1.dropna(inplace=True)
    chart = serialize(df1, render_to='my-chart', output_type='json',kind="line",title="West Indies Batsmen")
    return render_template('graph2.html', chart=chart)
...
def zimt_graph(chartID = 'chart_ID', chart_type = 'column', chart_height = 800):
    df1 = pd.read_excel("app/data/T20batters/ZIM.xls" ,index_col=[1])
    df1.dropna(inplace=True)
    chart = serialize(df1, render_to='my-chart', output_type='json',kind="line",title="Zimbawe Batsmen")
    return render_template('graph2.html', chart=chart)
...
def zim_Test_bowlers():
    df1 = pd.read_excel("app/data/testbowlers/ZIM.xls" ,index_col=[0])
    df1.dropna(inplace=True)
    table1 = df1.to_html(header=False,index=False,border=0)
...
def afg_Test_bowlers():
    df1 = pd.read_excel("app/data/testbowlers/AFG.xls" ,index_col=[0])
    df1.dropna(inplace=True)
    table1 = df1.to_html(header=False,index=False,border=0)
    with open("app/templates/testbowlers.html","r") as ht1:
        ht11 = ht1.read()
...
def aus_Test_bowlers():
    df1 = pd.read_excel("app/data/testbowlers/AUS.xls" ,index_col=[0])
    df1.dropna(inplace=True)
    table1 = df1.to_html(header=False,index=False,border=0)
    with open("app/templates/testbowlers.html","r") as ht1:
        ht11 = ht1.read()
...
def bdesh_Test_bowlers():
    df1 = pd.read_excel("app/data/testbowlers/BDESH.xls" ,index_col=[0])
    df1.dropna(inplace=True)
    table1 = df1.to_html(header=False,index=False,border=0)
    with open("app/templates/testbowlers.html","r") as ht1:
        ht11 = ht1.read()
...
def eng_Test_bowlers():
    df1 = pd.read_excel("app/data/testbowlers/ENG.xls" ,index_col=[0])
    df1.dropna(inplace=True)
    table1 = df1.to_html(header=False,index=False,border=0)
    with open("app/templates/testbowlers.html","r") as ht1:
        ht11 = ht1.read()
...
def india_Test_bowlers():
    df1 = pd.read_excel("app/data/testbowlers/INDIA.xls" ,index_col=[0])
    df1.dropna(inplace=True)
    table1 = df1.to_html(header=False,index=False,border=0)
    with open("app/templates/testbowlers.html","r") as ht1:
        ht11 = ht1.read()
...
def ire_Test_bowlers():
    df1 = pd.read_excel("app/data/testbowlers/IRE.xls" ,index_col=[0])
    df1.dropna(inplace=True)
    table1 = df1.to_html(header=False,index=False,border=0)
    with open("app/templates/testbowlers.html","r") as ht1:
        ht11 = ht1.read()
...
def nz_Test_bowlers():
    df1 = pd.read_excel("app/data/testbowlers/NZ.xls" ,index_col=[0])
    df1.dropna(inplace=True)
    table1 = df1.to_html(header=False,index=False,border=0)
    with open("app/templates/testbowlers.html","r") as ht1:
        ht11 = ht1.read()
...
def pak_Test_bowlers():
    df1 = pd.read_excel("app/data/testbowlers/PAK.xls" ,index_col=[0])
    df1.dropna(inplace=True)
    table1 = df1.to_html(header=False,index=False,border=0)
    with open("app/templates/testbowlers.html","r") as ht1:
        ht11 = ht1.read()
...
def sa_Test_bowlers():
    df1 = pd.read_excel("app/data/testbowlers/SA.xls" ,index_col=[0])
    df1.dropna(inplace=True)
    table1 = df1.to_html(header=False,index=False,border=0)
    with open("app/templates/testbowlers.html","r") as ht1:
        ht11 = ht1.read()
...
def sl_Test_bowlers():
    df1 = pd.read_excel("app/data/testbowlers/SL.xls" ,index_col=[0])
    df1.dropna(inplace=True)
    table1 = df1.to_html(header=False,index=False,border=0)
    with open("app/templates/testbowlers.html","r") as ht1:
        ht11 = ht1.read()
...
def wi_Test_bowlers():
    df1 = pd.read_excel("app/data/testbowlers/WI.xls" ,index_col=[0])
    df1.dropna(inplace=True)
    table1 = df1.to_html(header=False,index=False,border=0)
    with open("app/templates/testbowlers.html","r") as ht1:
        ht11 = ht1.read()
...
def indtb_graph(chartID = 'chart_ID', chart_type = 'column', chart_height = 800):
    df1 = pd.read_excel("app/data/testbowlers/INDIA.xls" ,index_col=[1])
    df1.dropna(inplace=True)
...
def afgtb_graph(chartID = 'chart_ID', chart_type = 'column', chart_height = 800):
    df1 = pd.read_excel("app/data/testbowlers/AFG.xls" ,index_col=[1])
    df1.dropna(inplace=True)
...
def austb_graph(chartID = 'chart_ID', chart_type = 'column', chart_height = 800):
    df1 = pd.read_excel("app/data/testbowlers/AUS.xls" ,index_col=[1])
    df1.dropna(inplace=True)
...
def bdeshtb_graph(chartID = 'chart_ID', chart_type = 'column', chart_height = 800):
    df1 = pd.read_excel("app/data/testbowlers/BDESH.xls" ,index_col=[1])
    df1.dropna(inplace=True)
...
def engtb_graph(chartID = 'chart_ID', chart_type = 'column', chart_height = 800):
    df1 = pd.read_excel("app/data/testbowlers/ENG.xls" ,index_col=[1])
    df1.dropna(inplace=True)
...
def iretb_graph(chartID = 'chart_ID', chart_type = 'column', chart_height = 800):
    df1 = pd.read_excel("app/data/testbowlers/IRE.xls" ,index_col=[1])
    df1.dropna(inplace=True)
...
def nztb_graph(chartID = 'chart_ID', chart_type = 'column', chart_height = 800):
    df1 = pd.read_excel("app/data/testbowlers/NZ.xls" ,index_col=[1])
    df1.dropna(inplace=True)
...
def paktb_graph(chartID = 'chart_ID', chart_type = 'column', chart_height = 800):
    df1 = pd.read_excel("app/data/testbowlers/PAK.xls" ,index_col=[1])
    df1.dropna(inplace=True)
...
def satb_graph(chartID = 'chart_ID', chart_type = 'column', chart_height = 800):
    df1 = pd.read_excel("app/data/testbowlers/SA.xls" ,index_col=[1])
    df1.dropna(inplace=True)
...
def sltb_graph(chartID = 'chart_ID', chart_type = 'column', chart_height = 800):
    df1 = pd.read_excel("app/data/testbowlers/SL.xls" ,index_col=[1])
    df1.dropna(inplace=True)
...
def witb_graph(chartID = 'chart_ID', chart_type = 'column', chart_height = 800):
    df1 = pd.read_excel("app/data/testbowlers/WI.xls" ,index_col=[1])
    df1.dropna(inplace=True)
...
def zimtb_graph(chartID = 'chart_ID', chart_type = 'column', chart_height = 800):
    df1 = pd.read_excel("app/data/testbowlers/ZIM.xls" ,index_col=[1])
    df1.dropna(inplace=True)
...
def zim_t20_bowlers():
    df1 = pd.read_excel("app/data/t20bowlers/ZIM.xls" ,index_col=[0])
    df1.dropna(inplace=True)
    table1 = df1.to_html(header=False,index=False,border=0)
...
def afg_t20_bowlers():
    df1 = pd.read_excel("app/data/t20bowlers/AFG.xls" ,index_col=[0])
    df1.dropna(inplace=True)
    table1 = df1.to_html(header=False,index=False,border=0)
    with open("app/templates/t20bowlers.html","r") as ht1:
        ht11 = ht1.read()
...
def aus_t20_bowlers():
    df1 = pd.read_excel("app/data/t20bowlers/AUS.xls" ,index_col=[0])
    df1.dropna(inplace=True)
    table1 = df1.to_html(header=False,index=False,border=0)
    with open("app/templates/t20bowlers.html","r") as ht1:
        ht11 = ht1.read()
...
def bdesh_t20_bowlers():
    df1 = pd.read_excel("app/data/t20bowlers/BDESH.xls" ,index_col=[0])
    df1.dropna(inplace=True)
    table1 = df1.to_html(header=False,index=False,border=0)
    with open("app/templates/t20bowlers.html","r") as ht1:
        ht11 = ht1.read()
...
def eng_t20_bowlers():
    df1 = pd.read_excel("app/data/t20bowlers/ENG.xls" ,index_col=[0])
    df1.dropna(inplace=True)
    table1 = df1.to_html(header=False,index=False,border=0)
    with open("app/templates/t20bowlers.html","r") as ht1:
        ht11 = ht1.read()
...
def india_t20_bowlers():
    df1 = pd.read_excel("app/data/t20bowlers/INDIA.xls" ,index_col=[0])
    df1.dropna(inplace=True)
    table1 = df1.to_html(header=False,index=False,border=0)
    with open("app/templates/t20bowlers.html","r") as ht1:
        ht11 = ht1.read()
...
def ire_t20_bowlers():
    df1 = pd.read_excel("app/data/t20bowlers/IRE.xls" ,index_col=[0])
    df1.dropna(inplace=True)
    table1 = df1.to_html(header=False,index=False,border=0)
    with open("app/templates/t20bowlers.html","r") as ht1:
        ht11 = ht1.read()
...
def nz_t20_bowlers():
    df1 = pd.read_excel("app/data/t20bowlers/NZ.xls" ,index_col=[0])
    df1.dropna(inplace=True)
    table1 = df1.to_html(header=False,index=False,border=0)
    with open("app/templates/t20bowlers.html","r") as ht1:
        ht11 = ht1.read()
...
def pak_t20_bowlers():
    df1 = pd.read_excel("app/data/t20bowlers/PAK.xls" ,index_col=[0])
    df1.dropna(inplace=True)
    table1 = df1.to_html(header=False,index=False,border=0)
    with open("app/templates/t20bowlers.html","r") as ht1:
        ht11 = ht1.read()
...
def sa_t20_bowlers():
    df1 = pd.read_excel("app/data/t20bowlers/SA.xls" ,index_col=[0])
    df1.dropna(inplace=True)
    table1 = df1.to_html(header=False,index=False,border=0)
    with open("app/templates/t20bowlers.html","r") as ht1:
        ht11 = ht1.read()
...
def sl_t20_bowlers():
    df1 = pd.read_excel("app/data/t20bowlers/SL.xls" ,index_col=[0])
    df1.dropna(inplace=True)
    table1 = df1.to_html(header=False,index=False,border=0)
    with open("app/templates/t20bowlers.html","r") as ht1:
        ht11 = ht1.read()
...
def wi_t20_bowlers():
    df1 = pd.read_excel("app/data/t20bowlers/WI.xls" ,index_col=[0])
    df1.dropna(inplace=True)
    table1 = df1.to_html(header=False,index=False,border=0)
    with open("app/templates/t20bowlers.html","r") as ht1:
        ht11 = ht1.read()
...
def indtt_graph(chartID = 'chart_ID', chart_type = 'column', chart_height = 800):
    df1 = pd.read_excel("app/data/t20bowlers/INDIA.xls" ,index_col=[1])
    df1.dropna(inplace=True)
    chart = serialize(df1, render_to='my-chart', output_type='json',kind="line",title="Indian Batsmen")
    return render_template('graph2.html', chart=chart)
...
def afgtt_graph(chartID = 'chart_ID', chart_type = 'column', chart_height = 800):
    df1 = pd.read_excel("app/data/t20bowlers/AFG.xls" ,index_col=[1])
    df1.dropna(inplace=True)
    chart = serialize(df1, render_to='my-chart', output_type='json',kind="line",title="Afghanistan Batsmen")
    return render_template('graph2.html', chart=chart)
...
def austt_graph(chartID = 'chart_ID', chart_type = 'column', chart_height = 800):
    df1 = pd.read_excel("app/data/t20bowlers/AUS.xls" ,index_col=[1])
    df1.dropna(inplace=True)
    chart = serialize(df1, render_to='my-chart', output_type='json',kind="line",title="Australia Batsmen")
    return render_template('graph2.html', chart=chart)
...
def bdeshtt_graph(chartID = 'chart_ID', chart_type = 'column', chart_height = 800):
    df1 = pd.read_excel("app/data/t20bowlers/BDESH.xls" ,index_col=[1])
    df1.dropna(inplace=True)
    chart = serialize(df1, render_to='my-chart', output_type='json',kind="line",title="Bangladesh Batsmen")
    return render_template('graph2.html', chart=chart)
...
def engtt_graph(chartID = 'chart_ID', chart_type = 'column', chart_height = 800):
    df1 = pd.read_excel("app/data/t20bowlers/ENG.xls" ,index_col=[1])
    df1.dropna(inplace=True)
    chart = serialize(df1, render_to='my-chart', output_type='json',kind="line",title="England Batsmen")
    return render_template('graph2.html', chart=chart)
...
def irett_graph(chartID = 'chart_ID', chart_type = 'column', chart_height = 800):
    df1 = pd.read_excel("app/data/t20bowlers/IRE.xls" ,index_col=[1])
    df1.dropna(inplace=True)
    chart = serialize(df1, render_to='my-chart', output_type='json',kind="line",title="IRELAND Batsmen")
    return render_template('graph2.html', chart=chart)
...
def nztt_graph(chartID = 'chart_ID', chart_type = 'column', chart_height = 800):
    df1 = pd.read_excel("app/data/t20bowlers/NZ.xls" ,index_col=[1])
    df1.dropna(inplace=True)
    chart = serialize(df1, render_to='my-chart', output_type='json',kind="line",title="New-Zealand Batsmen")
    return render_template('graph2.html', chart=chart)
...
def paktt_graph(chartID = 'chart_ID', chart_type = 'column', chart_height = 800):
    df1 = pd.read_excel("app/data/t20bowlers/PAK.xls" ,index_col=[1])
    df1.dropna(inplace=True)
    chart = serialize(df1, render_to='my-chart', output_type='json',kind="line",title="Pakistan Batsmen")
    return render_template('graph2.html', chart=chart)
...
def satt_graph(chartID = 'chart_ID', chart_type = 'column', chart_height = 800):
    df1 = pd.read_excel("app/data/t20bowlers/SA.xls" ,index_col=[1])
    df1.dropna(inplace=True)
    chart = serialize(df1, render_to='my-chart', output_type='json',kind="line",title="South Africa Batsmen")
    return render_template('graph2.html', chart=chart)
...
def sltt_graph(chartID = 'chart_ID', chart_type = 'column', chart_height = 800):
    df1 = pd.read_excel("app/data/t20bowlers/SL.xls" ,index_col=[1])
    df1.dropna(inplace=True)
    chart = serialize(df1, render_to='my-chart', output_type='json',kind="line",title="Sri Lanka Batsmen")
    return render_template('graph2.html', chart=chart)
...
def witt_graph(chartID = 'chart_ID', chart_type = 'column', chart_height = 800):
    df1 = pd.read_excel("app/data/t20bowlers/WI.xls" ,index_col=[1])
    df1.dropna(inplace=True)
    chart = serialize(df1, render_to='my-chart', output_type='json',kind="line",title="West Indies Batsmen")
    return render_template('graph2.html', chart=chart)
...
def zimtt_graph(chartID = 'chart_ID', chart_type = 'column', chart_height = 800):
    df1 = pd.read_excel("app/data/t20bowlers/ZIM.xls" ,index_col=[1])
    df1.dropna(inplace=True)
    chart = serialize(df1, render_to='my-chart', output_type='json',kind="line",title="Zimbawe Batsmen")
    return render_template('graph2.html', chart=chart)
...
def zim_odi_bowlers():
    df1 = pd.read_excel("app/data/odibowlers/ZIM.xls" ,index_col=[0])
    df1.dropna(inplace=True)
    table1 = df1.to_html(header=False,index=False,border=0)
...
def afg_odi_bowlers():
    df1 = pd.read_excel("app/data/odibowlers/AFG.xls" ,index_col=[0])
    df1.dropna(inplace=True)
    table1 = df1.to_html(header=False,index=False,border=0)
    with open("app/templates/odibowlers.html","r") as ht1:
        ht11 = ht1.read()
...
def aus_odi_bowlers():
    df1 = pd.read_excel("app/data/odibowlers/AUS.xls" ,index_col=[0])
    df1.dropna(inplace=True)
    table1 = df1.to_html(header=False,index=False,border=0)
    with open("app/templates/odibowlers.html","r") as ht1:
        ht11 = ht1.read()
...
def bdesh_odi_bowlers():
    df1 = pd.read_excel("app/data/odibowlers/BDESH.xls" ,index_col=[0])
    df1.dropna(inplace=True)
    table1 = df1.to_html(header=False,index=False,border=0)
    with open("app/templates/odibowlers.html","r") as ht1:
        ht11 = ht1.read()
...
def eng_odi_bowlers():
    df1 = pd.read_excel("app/data/odibowlers/ENG.xls" ,index_col=[0])
    df1.dropna(inplace=True)
    table1 = df1.to_html(header=False,index=False,border=0)
    with open("app/templates/odibowlers.html","r") as ht1:
        ht11 = ht1.read()
...
def india_odi_bowlers():
    df1 = pd.read_excel("app/data/odibowlers/INDIA.xls" ,index_col=[0])
    df1.dropna(inplace=True)
    table1 = df1.to_html(header=False,index=False,border=0)
    with open("app/templates/odibowlers.html","r") as ht1:
        ht11 = ht1.read()
...
def ire_odi_bowlers():
    df1 = pd.read_excel("app/data/odibowlers/IRE.xls" ,index_col=[0])
    df1.dropna(inplace=True)
    table1 = df1.to_html(header=False,index=False,border=0)
    with open("app/templates/odibowlers.html","r") as ht1:
        ht11 = ht1.read()
...
def nz_odi_bowlers():
    df1 = pd.read_excel("app/data/odibowlers/NZ.xls" ,index_col=[0])
    df1.dropna(inplace=True)
    table1 = df1.to_html(header=False,index=False,border=0)
    with open("app/templates/odibowlers.html","r") as ht1:
        ht11 = ht1.read()
...
def pak_odi_bowlers():
    df1 = pd.read_excel("app/data/odibowlers/PAK.xls" ,index_col=[0])
    df1.dropna(inplace=True)
    table1 = df1.to_html(header=False,index=False,border=0)
    with open("app/templates/odibowlers.html","r") as ht1:
        ht11 = ht1.read()
...
def sa_odi_bowlers():
    df1 = pd.read_excel("app/data/odibowlers/SA.xls" ,index_col=[0])
    df1.dropna(inplace=True)
    table1 = df1.to_html(header=False,index=False,border=0)
    with open("app/templates/odibowlers.html","r") as ht1:
        ht11 = ht1.read()
...
def sl_odi_bowlers():
    df1 = pd.read_excel("app/data/odibowlers/SL.xls" ,index_col=[0])
    df1.dropna(inplace=True)
    table1 = df1.to_html(header=False,index=False,border=0)
    with open("app/templates/odibowlers.html","r") as ht1:
        ht11 = ht1.read()
...
def wi_odi_bowlers():
    df1 = pd.read_excel("app/data/odibowlers/WI.xls" ,index_col=[0])
    df1.dropna(inplace=True)
    table1 = df1.to_html(header=False,index=False,border=0)
    with open("app/templates/odibowlers.html","r") as ht1:
        ht11 = ht1.read()
...
def indto_graph(chartID = 'chart_ID', chart_type = 'column', chart_height = 800):
    df1 = pd.read_excel("app/data/odibowlers/INDIA.xls" ,index_col=[1])
    df1.dropna(inplace=True)
    chart = serialize(df1, render_to='my-chart', output_type='json',kind="line",title="Indian Batsmen")
    return render_template('graph2.html', chart=chart)
...
def afgto_graph(chartID = 'chart_ID', chart_type = 'column', chart_height = 800):
    df1 = pd.read_excel("app/data/odibowlers/AFG.xls" ,index_col=[1])
    df1.dropna(inplace=True)
    chart = serialize(df1, render_to='my-chart', output_type='json',kind="line",title="Afghanistan Batsmen")
    return render_template('graph2.html', chart=chart)
...
def austo_graph(chartID = 'chart_ID', chart_type = 'column', chart_height = 800):
    df1 = pd.read_excel("app/data/odibowlers/AUS.xls" ,index_col=[1])
    df1.dropna(inplace=True)
    chart = serialize(df1, render_to='my-chart', output_type='json',kind="line",title="Australia Batsmen")
    return render_template('graph2.html', chart=chart)
...
def bdeshto_graph(chartID = 'chart_ID', chart_type = 'column', chart_height = 800):
    df1 = pd.read_excel("app/data/odibowlers/BDESH.xls" ,index_col=[1])
    df1.dropna(inplace=True)
    chart = serialize(df1, render_to='my-chart', output_type='json',kind="line",title="Bangladesh Batsmen")
    return render_template('graph2.html', chart=chart)
...
def engto_graph(chartID = 'chart_ID', chart_type = 'column', chart_height = 800):
    df1 = pd.read_excel("app/data/odibowlers/ENG.xls" ,index_col=[1])
    df1.dropna(inplace=True)
    chart = serialize(df1, render_to='my-chart', output_type='json',kind="line",title="England Batsmen")
    return render_template('graph2.html', chart=chart)
...
def ireto_graph(chartID = 'chart_ID', chart_type = 'column', chart_height = 800):
    df1 = pd.read_excel("app/data/odibowlers/IRE.xls" ,index_col=[1])
    df1.dropna(inplace=True)
    chart = serialize(df1, render_to='my-chart', output_type='json',kind="line",title="IRELAND Batsmen")
    return render_template('graph2.html', chart=chart)
...
def nzto_graph(chartID = 'chart_ID', chart_type = 'column', chart_height = 800):
    df1 = pd.read_excel("app/data/odibowlers/NZ.xls" ,index_col=[1])
    df1.dropna(inplace=True)
    chart = serialize(df1, render_to='my-chart', output_type='json',kind="line",title="New-Zealand Batsmen")
    return render_template('graph2.html', chart=chart)
...
def pakto_graph(chartID = 'chart_ID', chart_type = 'column', chart_height = 800):
    df1 = pd.read_excel("app/data/odibowlers/PAK.xls" ,index_col=[1])
    df1.dropna(inplace=True)
    chart = serialize(df1, render_to='my-chart', output_type='json',kind="line",title="Pakistan Batsmen")
    return render_template('graph2.html', chart=chart)
...
def sato_graph(chartID = 'chart_ID', chart_type = 'column', chart_height = 800):
    df1 = pd.read_excel("app/data/odibowlers/SA.xls" ,index_col=[1])
    df1.dropna(inplace=True)
    chart = serialize(df1, render_to='my-chart', output_type='json',kind="line",title="South Africa Batsmen")
    return render_template('graph2.html', chart=chart)
...
def slto_graph(chartID = 'chart_ID', chart_type = 'column', chart_height = 800):
    df1 = pd.read_excel("app/data/odibowlers/SL.xls" ,index_col=[1])
    df1.dropna(inplace=True)
    chart = serialize(df1, render_to='my-chart', output_type='json',kind="line",title="Sri Lanka Batsmen")
    return render_template('graph2.html', chart=chart)
...
def wito_graph(chartID = 'chart_ID', chart_type = 'column', chart_height = 800):
    df1 = pd.read_excel("app/data/odibowlers/WI.xls" ,index_col=[1])
    df1.dropna(inplace=True)
    chart = serialize(df1, render_to='my-chart', output_type='json',kind="line",title="West Indies Batsmen")
    return render_template('graph2.html', chart=chart)
...
def zimto_graph(chartID = 'chart_ID', chart_type = 'column', chart_height = 800):
    df1 = pd.read_excel("app/data/odibowlers/ZIM.xls" ,index_col=[1])
    df1.dropna(inplace=True)
    chart = serialize(df1, render_to='my-chart', output_type='json',kind="line",title="Zimbawe Batsmen")
    return render_template('graph2.html', chart=chart)
